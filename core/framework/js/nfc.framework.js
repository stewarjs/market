 ...
 * https://modernizr.com/download/?-csscolumns-inputtypes-setclasses !*/
!function(e,t,n){function r(e,t){return typeof e===t}function o(){var e,t,n,o,i,s,a;for(var l in C)if(C.hasOwnProperty(l)){if(e=[],t=C[l],t.name&&(e.push(t.name.toLowerCase()),t.options&&t.options.aliases&&t.options.aliases.length))for(n=0;n<t.options.aliases.length;n++)e.push(t.options.aliases[n].toLowerCase());for(o=r(t.fn,"function")?t.fn():t.fn,i=0;i<e.length;i++)s=e[i],a=s.split("."),1===a.length?Modernizr[a[0]]=o:(!Modernizr[a[0]]||Modernizr[a[0]]instanceof Boolean||(Modernizr[a[0]]=new Boolean(Modernizr[a[0]])),Modernizr[a[0]][a[1]]=o),g.push((o?"":"no-")+a.join("-"))}}function i(e){var t=b.className,n=Modernizr._config.classPrefix||"";if(S&&(t=t.baseVal),Modernizr._config.enableJSClass){var r=new RegExp("(^|\\s)"+n+"no-js(\\s|$)");t=t.replace(r,"$1"+n+"js$2")}Modernizr._config.enableClasses&&(t+=" "+n+e.join(" "+n),S?b.className.baseVal=t:b.className=t)}function s(e,t){return!!~(""+e).indexOf(t)}function a(){return"function"!=typeof t.createElement?t.createElement(arguments[0]):S?t.createElementNS.call(t,"http://www.w3.org/2000/svg",arguments[0]):t.createElement.apply(t,arguments)}function l(e){return e.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")}function u(e,t){return function(){return e.apply(t,arguments)}}function f(e,t,n){var o;for(var i in e)if(e[i]in t)return n===!1?e[i]:(o=t[e[i]],r(o,"function")?u(o,n||t):o);return!1}function d(e){return e.replace(/([A-Z])/g,function(e,t){return"-"+t.toLowerCase()}).replace(/^ms-/,"-ms-")}function c(){var e=t.body;return e||(e=a(S?"svg":"body"),e.fake=!0),e}function p(e,n,r,o){var i,s,l,u,f="modernizr",d=a("div"),p=c();if(parseInt(r,10))for(;r--;)l=a("div"),l.id=o?o[r]:f+(r+1),d.appendChild(l);return i=a("style"),i.type="text/css",i.id="s"+f,(p.fake?p:d).appendChild(i),p.appendChild(d),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(t.createTextNode(e)),d.id=f,p.fake&&(p.style.background="",p.style.overflow="hidden",u=b.style.overflow,b.style.overflow="hidden",b.appendChild(p)),s=n(d,e),p.fake?(p.parentNode.removeChild(p),b.style.overflow=u,b.offsetHeight):d.parentNode.removeChild(d),!!s}function m(t,r){var o=t.length;if("CSS"in e&&"supports"in e.CSS){for(;o--;)if(e.CSS.supports(d(t[o]),r))return!0;return!1}if("CSSSupportsRule"in e){for(var i=[];o--;)i.push("("+d(t[o])+":"+r+")");return i=i.join(" or "),p("@supports ("+i+") { #modernizr { position: absolute; } }",function(e){return"absolute"==getComputedStyle(e,null).position})}return n}function h(e,t,o,i){function u(){d&&(delete E.style,delete E.modElem)}if(i=r(i,"undefined")?!1:i,!r(o,"undefined")){var f=m(e,o);if(!r(f,"undefined"))return f}for(var d,c,p,h,y,v=["modernizr","tspan","samp"];!E.style&&v.length;)d=!0,E.modElem=a(v.shift()),E.style=E.modElem.style;for(p=e.length,c=0;p>c;c++)if(h=e[c],y=E.style[h],s(h,"-")&&(h=l(h)),E.style[h]!==n){if(i||r(o,"undefined"))return u(),"pfx"==t?h:!0;try{E.style[h]=o}catch(g){}if(E.style[h]!=y)return u(),"pfx"==t?h:!0}return u(),!1}function y(e,t,n,o,i){var s=e.charAt(0).toUpperCase()+e.slice(1),a=(e+" "+k.join(s+" ")+s).split(" ");return r(t,"string")||r(t,"undefined")?h(a,t,o,i):(a=(e+" "+x.join(s+" ")+s).split(" "),f(a,t,n))}function v(e,t,r){return y(e,n,n,t,r)}var g=[],C=[],w={_version:"3.3.1",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,t){var n=this;setTimeout(function(){t(n[e])},0)},addTest:function(e,t,n){C.push({name:e,fn:t,options:n})},addAsyncTest:function(e){C.push({name:null,fn:e})}},Modernizr=function(){};Modernizr.prototype=w,Modernizr=new Modernizr;var b=t.documentElement,S="svg"===b.nodeName.toLowerCase(),_="Moz O ms Webkit",k=w._config.usePrefixes?_.split(" "):[];w._cssomPrefixes=k;var x=w._config.usePrefixes?_.toLowerCase().split(" "):[];w._domPrefixes=x;var A={elem:a("modernizr")};Modernizr._q.push(function(){delete A.elem});var E={style:A.elem.style};Modernizr._q.unshift(function(){delete E.style}),w.testAllProps=y,w.testAllProps=v,function(){Modernizr.addTest("csscolumns",function(){var e=!1,t=v("columnCount");try{(e=!!t)&&(e=new Boolean(e))}catch(n){}return e});for(var e,t,n=["Width","Span","Fill","Gap","Rule","RuleColor","RuleStyle","RuleWidth","BreakBefore","BreakAfter","BreakInside"],r=0;r<n.length;r++)e=n[r].toLowerCase(),t=v("column"+n[r]),("breakbefore"===e||"breakafter"===e||"breakinside"==e)&&(t=t||v(n[r])),Modernizr.addTest("csscolumns."+e,t)}();var P=a("input"),T="search tel url email datetime date month week time datetime-local number range color".split(" "),z={};Modernizr.inputtypes=function(e){for(var r,o,i,s=e.length,a="1)",l=0;s>l;l++)P.setAttribute("type",r=e[l]),i="text"!==P.type&&"style"in P,i&&(P.value=a,P.style.cssText="position:absolute;visibility:hidden;",/^range$/.test(r)&&P.style.WebkitAppearance!==n?(b.appendChild(P),o=t.defaultView,i=o.getComputedStyle&&"textfield"!==o.getComputedStyle(P,null).WebkitAppearance&&0!==P.offsetHeight,b.removeChild(P)):/^(search|tel)$/.test(r)||(i=/^(url|email)$/.test(r)?P.checkValidity&&P.checkValidity()===!1:P.value!=a)),z[e[l]]=!!i;return z}(T),o(),i(g),delete w.addTest,delete w.addAsyncTest;for(var N=0;N<Modernizr._q.length;N++)Modernizr._q[N]();e.Modernizr=Modernizr}(window,document);
...
/* Original jQuery datepicker code modified to enhance accessibility and fix infractions */
...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		prevText: "View Previous Month", // Display text for previous month link
		nextText: "View Next Month", // Display text for next month link
...
$.extend( Datepicker.prototype, {
	...
	_newInst: function( target, inline ) {
		...
		return { id: id, input: target, // associated target
			...
			datepicker_bindHover( $( "<aside class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all' aria-label=\"Pick a date from the calendar\"></aside>" ) ) ) };
	},
	...
	_selectDay: function( id, month, year, td ) {
		...
		inst = this._getInst( target[ 0 ] );
		inst.selectedDay = inst.currentDay = $( "button abbr", td ).html();
	...
	_generateHTML: function( inst ) {
		...
		prev = ( this._canAdjustMonth( inst, -1, drawYear, drawMonth ) ?
			"<button class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +
			" title='" + prevText + "'><svg role=\"presentation\" viewBox=\"0 0 20 20\" class=\"ui-datepicker__svg\"><path d=\"M10 0.4c-5.3 0-9.6 4.3-9.6 9.6 0 5.3 4.3 9.6 9.6 9.6 5.3 0 9.6-4.3 9.6-9.6C19.6 4.7 15.3 0.4 10 0.4zM10 17.6c-4.2 0-7.6-3.4-7.6-7.6s3.4-7.6 7.6-7.6S17.6 5.8 17.6 10 14.2 17.6 10 17.6zM10 5.5L5.5 10l4.5 4.5V12h4V8h-4V5.5z\"/></svg><span class='ui-icon'>" + prevText + "</span></button>" :
			( hideIfNoPrevNext ? "" : "<button class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + prevText + "'><svg role=\"presentation\" viewBox=\"0 0 20 20\" class=\"ui-datepicker__svg\"><path d=\"M10 0.4c-5.3 0-9.6 4.3-9.6 9.6 0 5.3 4.3 9.6 9.6 9.6 5.3 0 9.6-4.3 9.6-9.6C19.6 4.7 15.3 0.4 10 0.4zM10 17.6c-4.2 0-7.6-3.4-7.6-7.6s3.4-7.6 7.6-7.6S17.6 5.8 17.6 10 14.2 17.6 10 17.6zM10 5.5L5.5 10l4.5 4.5V12h4V8h-4V5.5z\"/></svg><span class='ui-icon'>" + prevText + "</span></button>" ) );
		...
		next = ( this._canAdjustMonth( inst, +1, drawYear, drawMonth ) ?
			"<button class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" +
			" title='" + nextText + "'><svg viewBox=\"0 0 20 20\" role=\"presentation\" class=\"ui-datepicker__svg\"><path d=\"M10 0.4c-5.3 0-9.6 4.3-9.6 9.6 0 5.3 4.3 9.6 9.6 9.6 5.3 0 9.6-4.3 9.6-9.6C19.6 4.7 15.3 0.4 10 0.4zM10 17.6c-4.2 0-7.6-3.4-7.6-7.6s3.4-7.6 7.6-7.6S17.6 5.8 17.6 10 14.2 17.6 10 17.6zM10 8H6v4h4v2.5l4.5-4.5L10 5.5V8z\"/></svg><span class='ui-icon'>" + nextText + "</span></button>" :
			( hideIfNoPrevNext ? "" : "<button class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + nextText + "'><svg viewBox=\"0 0 20 20\" role=\"presentation\" class=\"ui-datepicker__svg\"><path d=\"M10 0.4c-5.3 0-9.6 4.3-9.6 9.6 0 5.3 4.3 9.6 9.6 9.6 5.3 0 9.6-4.3 9.6-9.6C19.6 4.7 15.3 0.4 10 0.4zM10 17.6c-4.2 0-7.6-3.4-7.6-7.6s3.4-7.6 7.6-7.6S17.6 5.8 17.6 10 14.2 17.6 10 17.6zM10 8H6v4h4v2.5l4.5-4.5L10 5.5V8z\"/></svg><span class='ui-icon'>" + nextText + "</span></button>" ) );
			...
			for ( col = 0; col < numMonths[ 1 ]; col++ ) {
				...
				for ( dow = 0; dow < 7; dow++ ) { // days of the week
					...
					thead += "<th scope='col'" + ( ( dow + firstDay + 6 ) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "" ) + ">" +
						"<abbr title='" + dayNames[ day ] + "'>" + dayNamesMin[ day ] + "</abbr></th>";
				}
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							"'><abbr title='" + monthNames[printDate.getMonth()] + ", " + printDate.getDate() + " " + printDate.getFullYear() + "'>" + printDate.getDate() + "</button>" ) ) + "</td>"; // display selectable date
...
( function( window, document )
{
    ...
    if( isLocalStorage && localStorage.getItem( 'market_gardenRev' ) == revision )
    {
        data = localStorage.getItem( 'market_garden' );
        if( data )
        {
            insert();
            return true;
    ...
    try
    {
        ...
        request.onload = function()
        {
            if( request.status >= 200 && request.status < 400 )
            {
                ...
                if( isLocalStorage )
                {
                    localStorage.setItem( 'market_garden',  data );
                    localStorage.setItem( 'market_gardenRev',   revision );
                }
            }
        }
        request.send();
...
var i = 0,
	...
	navPanel = document.querySelector('.menu__container');
...
window.onload = function() {
	...
	$('#skipheader').skipTo('#nav');
	
	resizeMenu();
	
	if(document.querySelector('.label--inline')) {
        $('.label--inline').each(function() {
			$label = $(this);
			$parentInput = $label.prev('input');
			...
			$parentInput.on('focus', function() {
				var $this = $(this);    
				$this.next('label').css('text-indent','-9999px');
			}).on('blur', function() {
				var $this = $(this);
				if($this.val() == '') {
					  $this.next('label').css('text-indent','0px');
				}
			});
...
function resizeMenu() {
	...
	if(navPanel != null) {
		var windowHeight = Math.max(document.body.clientHeight, window.innerHeight || 0);
		if(windowHeight >= navPanel.offsetHeight) {
			navPanel.style.height = windowHeight + 'px';
		};
	};
...
function menuOpen(menu) {
	var subMenu = menu.nextElementSibling || nextElementSibling(menu);
	if(subMenu.className == ''){
		$(menu).attr({'aria-expanded':'true'}).toggleClass('menu__item--active');
		$(subMenu).css({visibility: "visible"}).attr({'tabindex':'-1'}).animateAuto("width", 200, '200px');
	};
};
...
function menuClose(menu) {
	var subMenu = menu.nextElementSibling || nextElementSibling(menu);
	if(subMenu.className == ''){
		$(menu).attr({'aria-expanded':'false'}).toggleClass('menu__item--active');
		//$(menu).focus();
		$(subMenu).animate({width: 0}, 200, function() {
			//$(menu).removeAttr('tabindex');
			$(subMenu).css({visibility: "hidden"}).removeAttr('tabindex');
		});
	};
};
...
/*  Modification to the native jQuery $.load() function. When retrieving via selector
	we don't want the parents of the selector.
   ========================================================================================= */	
...
/* App Timeout Function
   ========================================================================== */
$.timeoutApp = function(url){   

    var idleTime = 0,
        finalTime = 0,
   	    idleInterval,
        showTimeoutWarning = 900000, // When to show warning dialog. Set to 15 minutes (900000 in milliseconds)
        dialogTime = 30; // How long to show timeout warning dialog. Set to 30 seconds (in seconds)
	$(document).ready(function () {
		timerStart(timerIncrement, showTimeoutWarning);
	...
	function timerStart(incrementFunction, increment) {
		//Increment the idle time counter every minute.
		idleInterval = setInterval(incrementFunction, increment); // 1 minute
	}
	...
	function timerIncrement() {
		idleTime = idleTime + 1;
		if (idleTime > 1) { // 15 minutes is hard coded for Accessibility compliance.
			timerReset();
			$('.modal__window').each(function() {
                $(this).remove();
            });
			$.modal({title:'Attention!', content:'<p>You are about to time out of the application for inactivity. Please make a selection from the button choices below.</p><p class="align--center">You will be logged out in <span aria-live="assertive" id="nfcf_countdown">30 seconds</span>.</p>', footer: '<div class="button-group button-group--directional"><button type="reset" class="button button--gray" id="logout">Log out</button><button type="submit" class="button button--blue" id="continue">Stay signed in</button></div>'}).find('.modal__close-button').remove();
			
			timerStart(finalCountdown, 1000);
	...
	function finalCountdown() {
		...
		$('#nfcf_countdown').html((dialogTime - finalTime) + ' seconds');
		if (finalTime > dialogTime) { 
			timerReset();
			$('.modal__window').each(function() {
                $(this).remove();
            });
...
$.modal = function( options ) {
	...
	function showModal(modal) {
		...
		$('body').wrapInner( '<div aria-hidden="true" />').prepend(modal);
...
// TOOLTIP PUBLIC CLASS DEFINITION
  ...
  Tooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div tabindex="-1" class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 500,
    html: false,
...
function DropDown(element) {
	...
	this.namespace = '__custom-select';
	this.label == null;
	this.required = false;
    this.initEvents();
}
DropDown.prototype = {
	registerLabel : function() {
		var associatedLabel = document.querySelector('label[for=' + this.selectBox[0].id + ']');
		if(associatedLabel){
			// Label found
			associatedLabel.removeAttribute('for');
			associatedLabel.id = associatedLabel.id || 'label' + this.namespace;
			this.label = associatedLabel.id;
			return true;
		}else{
			return false;
		}
	...
	initEvents : function() {
       ...
       $($this.selectBox[0].attributes).each(function() {
		   if(!restrictedAttributes[this.name]) {
		...
		if($this.registerLabel() == true) {
			customSelect.setAttribute('aria-labelledby',this.label);
		};
        
        customSelect.setAttribute('id',$this.selectBox[0].id + $this.namespace);
        ...
        customPlaceholder = svg + '<span class="custom-select__placeholder">' + $this.selected.text() + (typeof($this.label) == 'undefined' && $this.required == true  ? ' <abbr title="This field requires input" class="label__required-field">*</abbr>' : '') + '</span>';
        svg = '';
		...
		// close the select element if the target it is not the select element or one of its descendants..
        ...
        function toggleSelect() {
            ...
            setTimeout(function(){ 
				if($this.status == 'closed') {
					...
					$this.optBox.attr({'aria-hidden':'false', 'tabindex':'0'}).focus();
					$this.status = 'open';
				}else{
        ...
        $this.optBox.find('a').on('click',function(e){
            var link = $(this),
                ...
                if($this.type == true || $this.type == 'true') {
                    ...
                    $this.selectBox.val(item.attr('data-value')).trigger('change');
                    e.preventDefault();
                }
        });
    }
